...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/rearrange-string-to-avoid-character-pair/)
...
**My Solution:** [3992-Rearrange-String-to-Avoid-Character-Pair.cpp](./3992-Rearrange-String-to-Avoid-Character-Pair.cpp)
