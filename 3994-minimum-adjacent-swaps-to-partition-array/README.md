...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/minimum-adjacent-swaps-to-partition-array/)
...
**My Solution:** [3994-Minimum-Adjacent-Swaps-to-Partition-Array.cpp](./3994-Minimum-Adjacent-Swaps-to-Partition-Array.cpp)
