...
🔴 **Hard** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/second-minimum-time-to-reach-destination/)
...
**My Solution:** [2045-Second-Minimum-Time-to-Reach-Destination.cpp](./2045-Second-Minimum-Time-to-Reach-Destination.cpp)
