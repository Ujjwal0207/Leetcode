...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/maximize-active-section-with-trade-i/)
...
**My Solution:** [3499-Maximize-Active-Section-with-Trade-I.cpp](./3499-Maximize-Active-Section-with-Trade-I.cpp)
